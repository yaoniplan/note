...
- ***References***
    - ChatGPT
- ---
- #### Disable the Reflector tool in Arch Linux
    - `systemctl stop reflector.timer`
        - `mv /etc/xdg/reflector/reflector.conf /tmp/` # Another way
- ***Notes***
    - Because to set a specifier mirror in iso.
...
- #### Add a user in Arch Linux
    - `sudo useradd -m yaoniplan`
- ***Notes***
    - `-m` # Create user's home directory
    - `passwd yaoniplan` # Change user password
- ***References***
    - ChatGPT
    - `man passwd`
    - `man useradd`
