...
- ***Notes***
	...
	- Beautiful
		- |theme|theme|theme|theme|
		  |---|---|---|---|
		  |squared-nord|squared-everforest|spotlight-dark|rounded-nord-dark|
		  |rounded-green-dark|rounded-gray-dark|rounded-blue-dark|nord-TwoLines|
		  |nord|nord-oneline|sidebar-v2 by Qball|fancy by DaveDavenport|
		  |dmenu by Qball|arthur by Qball| | |
- ***References***
