...
- ***Notes***
	...
	- Solve the problem
	  ...
	  ```
		...
		- `kill yourPID -9 pid` # Replace *yourPID* with *PID* you got
- ***References***
	- ![image.png](../assets/image_1670750559717_0.png)
	- ![image.png](../assets/image_1670750573466_0.png)
	- [http error - listen tcp 127.0.0.1:1087: bind: address already in use - Mac_Don_Interpreter的博客-CSDN博客](https://blog.csdn.net/weixin_42108437/article/details/106072810#commentBox)
