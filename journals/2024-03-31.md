...
- ---
- #### Use "uosc"
    - `vim ~/.config/mpv/script-opts/uosc.conf` # Configure as needed
      ```
      ...
      autoload=yes
      ```
    - `vim ~/.config/mpv/input.conf` # Configure as needed
      ```
      ...
      # Avoid accidentally placing the mouse on the controller
