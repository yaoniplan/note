- ---
- #### Use "git"
    - `git clone https://yaoniplan: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@github.com/yaoniplan/diary` # Clone a private repository
        - `yaoniplan` # Replace it with your user name
        - `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` # Your PAT
    - Test some files
