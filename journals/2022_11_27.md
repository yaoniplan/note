...
- Nordic-darker theme installation
	...
	- ***Notes***
		...
		- `/usr/share/themes/` # Add your theme folder to the Themes derectory
- ---
...
- ---
- Lxappearance installation #GTK #Theme
	- `sudo emerge -aq lxde-base/lxappearance`
- ---
- Rofi installation #I3WM #Gentoo #Linux
