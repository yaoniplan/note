...
- ***Notes***
    ...
    - Upload file
      ...
      ```
        ...
        - `&storage_config_id=9325ee6a-1452-4ca2-85bc-807216d82e30` # Specify the corresponding storage bucket
...
- ***References***
    ...
    - https://github.com/ling-drag0n/CloudPaste/blob/main/Api-doc.md # `/api/paste` `/upload-direct`
- ---
