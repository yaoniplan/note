- #### Use "webdav"
    - `http://admin:***@192.168.10.100:5244/dav/$filePath/index.js` # Download (Access a specific file)
    - `curl --user "admin:***" --upload-file "/mnt/grow/image/2024-06-04-171256.png" "http://192.168.10.100:5244/dav/$filePath/"` # Upload
- ***Notes***
